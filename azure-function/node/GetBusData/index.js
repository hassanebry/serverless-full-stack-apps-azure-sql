...
module.exports = async function (context, myTimer) {
  ...
  var buses = feed.entity.filter((e) => routes.includes(parseInt(e.vehicle.trip.route_id)));
...
async function TriggerLogicApp(context, geofence) {
  ...
  try {
    ...
    if (response.ok)
      context.log(`[${geofence.VehicleId}/${geofence.DirectionId}/${geofence.GeoFenceId}] WebHook called successfully`);
